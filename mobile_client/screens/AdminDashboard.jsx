    ...
    <ScreenContainer scrollable={false}>
      ...
      >
        ...
        <View style={styles.consoleGrid}>
          {/* "Users" and "Hospitals" are sibling tabs on AdminTabs - navigate() bubbles up to the tab navigator automatically */}
          <TouchableOpacity style={styles.consoleTile} onPress={() => navigation.navigate('Users')}>
            <Users size={32} color={Colors.primary} />
            <Text style={styles.consoleText}>User List</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.consoleTile} onPress={() => navigation.navigate('Hospitals')}>
            <Hospital size={32} color={Colors.primary} />
            <Text style={styles.consoleText}>Hospital List</Text>
          </TouchableOpacity>
          {/* Monitoring/Reports live inside this tab's own stack, see AdminTabs.js */}
